    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Modification Of Individual Protection Case</h5>
                </div>
            ...
            <form action="{{ route('individualprotection-cases.update-individualprotection-case', $cases->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="case_data[0][court]" id="court" list="court_list"
                                    ...
                                    class="form-input border-slate-200 dark:border-zink-500 w-full
