...
@section('sidebar')
    <div id="scrollbar"
        ...
        @include('pages.individual_protection.sidebar.sidebar')
        <!-- Left Sidebar End -->
    </div>
@endsection
{{-- content --}}
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Create An Individual Protection Case</h5>
                </div>
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('individualprotection-cases.individualprotection') }}" class="text-slate-400 dark:text-zink-200">Case</a>
                    </li>
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('individualprotection-cases.create-individualprotection-case') }}"
                            class="text-slate-400 dark:text-zink-200">Create New</a>
                    </li>
                    <li class="text-slate-700 dark:text-zink-100">Personal Support</li>
                </ul>
            </div>

            <form action="{{ route('individualprotection-cases.store-individualprotection-case') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="case_type" value="Personal Support">
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <a href="{{ route('individualprotection-cases.individualprotection') }}"
