    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Personal Protection List</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="text-15 grow">Personal Protection</h6>
                        <div class="flex gap-2 shrink-0">
                            ...
                            <a href="{{ route('individualprotection-cases.create-individualprotection-case') }}"
                                ...
                                <span class="align-middle">Add Individual Protection Cases</span>
                            </a>
                        </div>
                    </div>
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('individualprotection-cases.edit-individualprotection-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('individualprotection-cases.destroy-individualprotection-case', ':id') }}";
