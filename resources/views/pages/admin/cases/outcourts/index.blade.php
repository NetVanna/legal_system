    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Outcourt List</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="text-15 grow">Outcourt</h6>
                        <div class="flex gap-2 shrink-0">
                            ...
                            <a href="{{ route('cases.create-outcourt-case') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('cases.edit-outcourt-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('cases.destroy-outcourt-case', ':id') }}";
