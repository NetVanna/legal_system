                ...
                <div class="card-body">
                    <div class="flex items-center">
                        ...
                        <div class="flex gap-2 shrink-0">
                            ...
                            <a href="{{ route('cases.create-familyprotection-case') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('cases.edit-familyprotection-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('cases.destroy-familyprotection-case', ':id') }}";
