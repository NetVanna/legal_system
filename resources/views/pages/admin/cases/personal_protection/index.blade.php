                        ...
                        <div class="flex gap-2 shrink-0">
                            <a href="{{ route('cases.index') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" data-lucide="arrow-left"
                                    class="lucide lucide-arrow-left inline-block size-4">
                                    <path d="m12 19-7-7 7-7"></path>
                                    <path d="M19 12H5"></path>
                                </svg>
                                <span class="align-middle">Back</span>
                            </a>
                            <a href="{{ route('cases.create-personalprotection-case') }}"
                                ...
                                <span class="align-middle">Add Cases</span>
                            </a>
                        </div>
                    </div>
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('cases.edit-personalprotection-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('cases.destroy-personalprotection-case', ':id') }}";
