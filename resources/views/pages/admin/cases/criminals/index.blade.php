...
@section('content')
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Criminal List</h5>
                </div>
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="#!" class="text-slate-400 dark:text-zink-200">Cases Management</a>
                    </li>
                    <li class="text-slate-700 dark:text-zink-100">Criminal List</li>
                </ul>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center mb-4">
                        <h6 class="text-15 grow">Criminal Cases</h6>
                        <div class="flex gap-2 shrink-0">
                            <a href="{{ route('cases.index') }}"
                                class="text-white btn bg-slate-500 border-slate-500 hover:text-white hover:bg-slate-600 hover:border-slate-600">
                            ...
                            <a href="{{ route('cases.create-criminal-case') }}"
                                ...
                                <span class="align-middle">Add Criminal Case</span>
                            </a>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('cases.edit-criminal-case', $value->id) }}"
    ...
    <div id="clientRelativesModal" class="fixed inset-0 z-[1000] hidden overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="fixed inset-0 transition-opacity bg-black opacity-50" onclick="closeModal('clientRelativesModal')">
            </div>
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('cases.destroy-criminal-case', ':id') }}";
