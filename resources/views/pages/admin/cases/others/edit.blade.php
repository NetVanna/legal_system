    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Edit Other Cases</h5>
                </div>
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li class="text-slate-700 dark:text-zink-100">Other</li>
                </ul>
            </div>

            <form action="{{ route('cases.update-othercase-case', $cases->id) }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="case_type" value="Other">
