...
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Clients List</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="text-15 grow">Clients</h6>
                        <div class="shrink-0">
                            <button data-modal-target="addDepartmentModal" type="button"
                                ...
                                <span class="align-middle">Add Clients</span>
                            </button>
                        </div>
                    </div>
                    <br>
                    <table id="alternativePagination" class="display" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">
                                    Name</th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Email
                                </th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Phone
                                    Number</th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Address
                                </th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Gender
                                </th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Birth
                                    Date</th>
                                <th class="px-3.5 py-2.5 font-semibold border border-slate-200 dark:border-zink-500">Id Card
                                </th>
                        ...
                        <tbody>
                            @foreach ($clients as $key => $value)
                                <tr>
                                    ...
                                    <td id="department" class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->client_code }}</td>
                                    <td id="department" class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->name }}</td>
                                    <td id="head_of" class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->email }}</td>
                                    <td id="phone_number"
                                        class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->phone }}</td>
                                    <td id="email" class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->address }}</td>
                                    <td id="total_employee"
                                        class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->gender }}</td>
                                    <td id="total_employee"
                                        class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ \Carbon\Carbon::parse($value->birth_date)->format('d F Y') }}
                                    </td>
                                    <td id="total_employee"
                                        class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        {{ $value->id_card_num }}</td>
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <a class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"
                                                href="{{ url('page/account/' . $value->id) }}"><svg
                                            ...
                                            <a data-modal-target="editDepartmentModal"
                                                class="editClientBtn flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-8 text-slate-500 bg-slate-100 hover:text-white hover:bg-slate-500"
                                                data-id="{{ $value->id }}" data-code="{{ $value->client_code }}"
                                                data-name="{{ $value->name }}" data-type="{{ $value->client_type }}"
                                                data-company="{{ $value->company_name }}" data-email="{{ $value->email }}"
                                                data-phone="{{ $value->phone }}" data-address="{{ $value->address }}"
                                                data-gender="{{ $value->gender }}" data-birth="{{ $value->birth_date }}"
                                                data-idcard="{{ $value->id_card_num }}"
                                                data-instructor="{{ $value->instructor_id }}"
    ...
    <div id="addDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Add Clients</h5>
                ...
                <form action="{{ route('client.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-6">
                            <label for="addclientCodeInput" class="inline-block mb-2 text-base font-medium">Client Code
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="client_code" id="addclientCodeInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('client_code') is-invalid @enderror"
                                placeholder="Enter client code" value="{{ old('client_code') }}" required>
                            @error('client_code')
                        ...
                        <!-- Client Type -->
                        <div class="xl:col-span-6">
                            <label for="addclientTypeInput" class="inline-block mb-2 text-base font-medium">Client
                                Type</label>
                            <select name="client_type" id="addclientTypeInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                <option value="individual" {{ old('client_type') == 'individual' ? 'selected' : '' }}>
                                    Individual</option>
                                <option value="company" {{ old('client_type') == 'company' ? 'selected' : '' }}>Company
                                </option>
                            </select>
                            @error('client_type')
                                <span class="invalid-feedback text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>

                        <!-- Name -->
                        <div class="xl:col-span-6">
                            <label for="addnameInput" class="inline-block mb-2 text-base font-medium">Name <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="name" id="addnameInput"
                        ...
                        <div class="xl:col-span-6" id="companyNameField">
                            <label for="addcompanyNameInput" class="inline-block mb-2 text-base font-medium">Company
                                Name</label>
                            <input type="text" name="company_name" id="addcompanyNameInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('company_name') is-invalid @enderror"
                        ...
                        <!-- Email -->
                        <div class="xl:col-span-6">
                            <label for="addemailInput" class="inline-block mb-2 text-base font-medium">Email</label>
                        ...
                        <!-- Phone -->
                        <div class="xl:col-span-6">
                            <label for="addphoneNumberInput" class="inline-block mb-2 text-base font-medium">Phone
                                Number</label>
                            <input type="text" name="phone" id="addphoneNumberInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('phone') is-invalid @enderror"
                        ...
                        <!-- Gender -->
                        <div class="xl:col-span-6">
                            <label for="addgenderInput" class="inline-block mb-2 text-base font-medium">Gender</label>
                            <select name="gender" id="addgenderInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <!-- Birth Date -->
                        <div class="xl:col-span-6">
                            <label for="addbirthDateInput" class="inline-block mb-2 text-base font-medium">Birth
                                Date</label>
                            <input type="date" name="birth_date" id="addbirthDateInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('birth_date') is-invalid @enderror"
                        ...
                        <!-- ID Card Number -->
                        <div class="xl:col-span-6">
                            <label for="addidCardNumberInput" class="inline-block mb-2 text-base font-medium">ID Card
                                Number</label>
                            <input type="text" name="id_card_num" id="addidCardNumberInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('id_card_num') is-invalid @enderror"
                                placeholder="Enter ID card number" value="{{ old('id_card_num') }}">
                            @error('id_card_num')
                                <span class="invalid-feedback text-red-500 text-sm" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <!-- Instructor -->
                        <div class="xl:col-span-6">
                            <label for="addinstructorInput"
                                class="inline-block mb-2 text-base font-medium">Instructor</label>
                            <select name="instructor_id" id="addinstructorInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                        ...
                        <div class="xl:col-span-12">
                            <label for="addaddressInput" class="inline-block mb-2 text-base font-medium">Address</label>
                            <textarea name="address" id="addaddressInput" rows="3"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('address') is-invalid @enderror"
                        ...
                        <!-- Notes -->
                        <div class="xl:col-span-12">
                            <label for="addnotesInput" class="inline-block mb-2 text-base font-medium">Notes</label>
                            <textarea name="notes" id="addnotesInput" rows="3"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('notes') is-invalid @enderror"
    ...
    <div id="editDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Update Clients</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#" id="edit-form" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        {{-- Client Code --}}
                        <div class="xl:col-span-6">
                            <label for="clientCodeInput" class="inline-block mb-2 text-base font-medium">Client Code <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="client_code" id="clientCodeInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 @error('client_code') is-invalid @enderror"
                                required>
                        </div>

                        {{-- Client Type --}}
                        <div class="xl:col-span-6">
                            <label for="clientTypeInput" class="inline-block mb-2 text-base font-medium">Client
                                Type</label>
                            <select name="client_type" id="clientTypeInput"
                        ...
                        <div class="xl:col-span-6">
                            ...
                            <input type="text" name="name" id="nameInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 @error('name') is-invalid @enderror"
                                required>
                        </div>

                        {{-- Company Name --}}
                        <div class="xl:col-span-6" id="companyNameField">
                            <label for="companyNameInput" class="inline-block mb-2 text-base font-medium">Company
                                Name</label>
                        ...
                        {{-- Gender --}}
                        <div class="xl:col-span-6">
                            <label for="genderInput" class="inline-block mb-2 text-base font-medium">Gender</label>
                        ...
                        {{-- ID Card --}}
                        <div class="xl:col-span-6">
                            <label for="idCardNumberInput" class="inline-block mb-2 text-base font-medium">ID Card
                                Number</label>
                            <input type="text" name="id_card_num" id="idCardNumberInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                        </div>

                        {{-- Instructor --}}
                        <div class="xl:col-span-6">
                            <label for="instructorInput"
                                class="inline-block mb-2 text-base font-medium">Instructor</label>
                            <select name="instructor_id" id="instructorInput"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                                <option value="">Select Instructor</option>
                                @foreach ($instructors ?? [] as $instructor)
                        ...
                        {{-- Address --}}
                        <div class="xl:col-span-12">
                            <label for="addressInput" class="inline-block mb-2 text-base font-medium">Address</label>
                        ...
                        {{-- Notes --}}
                        <div class="xl:col-span-12">
                            <label for="notesInput" class="inline-block mb-2 text-base font-medium">Notes</label>
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="editDepartmentModal"
                            class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-600 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10">Cancel</button>
                        <button type="submit"
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.querySelectorAll(".editClientBtn").forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    // Fill values
                    document.getElementById("clientCodeInput").value = this.dataset.code || '';
                    document.getElementById("nameInput").value = this.dataset.name || '';
                    document.getElementById("companyNameInput").value = this.dataset.company || '';
                    document.getElementById("clientTypeInput").value = this.dataset.type ||
                        'individual';
                    document.getElementById("emailInput").value = this.dataset.email || '';
                    document.getElementById("phoneNumberInput").value = this.dataset.phone || '';
                    ...
                    document.getElementById("notesInput").value = this.dataset.notes || '';
                    document.getElementById("idCardNumberInput").value = this.dataset.idcard || '';
                    document.getElementById("instructorInput").value = this.dataset.instructor ||
                        '';

                    // Birth date formatting
                    let birth = this.dataset.birth || '';
                    if (birth) {
                    ...
                    document.getElementById("birthDateInput").value = birth;

                    // update action URL
                    document.getElementById("edit-form").action = "/client/list/" + this.dataset.id;
                });
            });
        });
    </script>
