...
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Positions List</h5>
                </div>
                                    ...
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <a href="#!" data-modal-target="editDepartmentModal" id="updateRecord"
                                                ...
                                                data-code="{{ $value->code }}"data-description="{{ $value->description }}"
    ...
    <div id="addDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Add Position</h5>
                ...
                <form action="{{ route('positions.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            <label for="nameInput" class="inline-block mb-2 text-base font-medium">
                                Position Name
                            </label>
                          ...
                          dark:placeholder:text-zink-200 @error('name') is-invalid @enderror"
                                placeholder="Enter position name" value="{{ old('name') }}">
                        ...
                        {{-- Code --}}
                        <div class="xl:col-span-12">
                            <label for="codeInput" class="inline-block mb-2 text-base font-medium">
                                Position Code
                            </label>
                            <input type="text" name="code"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500
                          dark:text-zink-100 dark:bg-zink-700 @error('code') is-invalid @enderror"
                                placeholder="Ex: HR-MGR" value="{{ old('code') }}">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <textarea name="description" rows="3"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500
                             dark:text-zink-100 dark:bg-zink-700 @error('description') is-invalid @enderror"
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                       ...
                       focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100
                       dark:bg-zink-600 dark:hover:bg-red-500/10">
                            Cancel
                        </button>
                        <button type="submit"
    ...
    <div id="editDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Edit Position</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#" method="POST" id="edit-form">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        {{-- Status --}}
                        <div class="xl:col-span-12">
                            <label for="statusInput" class="inline-block mb-2 text-base font-medium">
                                Status
                            </label>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.querySelectorAll(".editClientBtn").forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    document.getElementById("codeInput").value = this.dataset.code || '';
                    document.getElementById("descriptionInput").value = this.dataset.description ||
                        '';
                    document.getElementById("e_id_update").value = this.dataset.id || '';
                    ...
                    // Set form action (Laravel resource route)
                    const form = document.getElementById("edit-form");
                    form.action = "/positions/list/" + this.dataset.id; // <-- fix here
                });
            });
        });
    </script>
