    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">SubChapters List</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex items-center">
                        <h6 class="text-15 grow">SubChapters</h6>
                        <div class="shrink-0">
                            <button data-modal-target="addDepartmentModal" type="button"
                                ...
                                <span class="align-middle">Add SubChapters</span>
                            </button>
                        </div>
                    </div>
                    <br>
                    <table id="alternativePagination" class="display" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($subChapterDepartments as $key => $value)
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <a href="#!" data-modal-target="editDepartmentModal"
                                                ...
                                                data-id="{{ $value->id }}" data-chapter_id="{{ $value->chapter_id }}"
    ...
    <div id="addDepartmentModal" modal-center=""
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Add SubChapters Department</h5>
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('subchapter_department.store') }}" method="POST">
                    @csrf
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="chapter_id" class="inline-block mb-2 text-base font-medium">Chapter <span
                                    class="text-red-500">*</span></label>
                            <select name="chapter_id" id="chapter_id"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('chapter_id') is-invalid @enderror">
                                <option value="" disabled>Select Chapter</option>
                                @if (isset($chapterDepartments))
                                    @foreach ($chapterDepartments as $chapterDept)
                                        <option value="{{ $chapterDept->id }}"
                                            {{ old('chapter_id') == $chapterDept->id ? 'selected' : '' }}>
                                            {{ $chapterDept->name }}
                                        </option>
                                    @endforeach
                                @endif
                        ...
                        <div class="xl:col-span-12">
                            <label for="code" class="inline-block mb-2 text-base font-medium">Code <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="code" id="code"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('code') is-invalid @enderror"
                        ...
                        <div class="xl:col-span-12">
                            <label for="departmentInput" class="inline-block mb-2 text-base font-medium">Name <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="xl:col-span-12">
                            <label for="headOfInput" class="inline-block mb-2 text-base font-medium">Description</label>
                            <textarea name="description" id="headOfInput" rows="3"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('description') is-invalid @enderror"
                        ...
                        <div class="xl:col-span-12">
                            <label for="head_user_id" class="inline-block mb-2 text-base font-medium">Head User</label>
                            <select name="head_user_id" id="head_user_id"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('head_user_id') is-invalid @enderror">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <select name="status" id="status"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 @error('status') is-invalid @enderror">
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="#" method="POST" id="edit-form">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <label for="e_chapter_id" class="inline-block mb-2 text-base font-medium">Chapter <span
                                    class="text-red-500">*</span></label>
                            <select name="chapter_id" id="e_chapter_id"
                        ...
                        <div class="xl:col-span-12">
                            <label for="e_code" class="inline-block mb-2 text-base font-medium">Code <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="code" id="e_code"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Enter code">
                        </div>

                        <div class="xl:col-span-12">
                            <label for="e_departmentInput" class="inline-block mb-2 text-base font-medium">Name <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div class="xl:col-span-12">
                            <label for="e_headOfInput" class="inline-block mb-2 text-base font-medium">Description</label>
                            <textarea name="description" id="e_headOfInput" rows="3"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Enter description"></textarea>
                        </div>

                        <div class="xl:col-span-12">
                            <label for="e_head_user_id" class="inline-block mb-2 text-base font-medium">Head User</label>
                            <select name="head_user_id" id="e_head_user_id"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                <option value="" disabled>Select Head User</option>
                                @foreach ($users as $user)
                        ...
                        <div class="xl:col-span-12">
                            <label for="e_status" class="inline-block mb-2 text-base font-medium">Status <span
                                    class="text-red-500">*</span></label>
...
@section('script')
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.querySelectorAll(".editClientBtn").forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    document.getElementById("e_chapter_id").value = this.dataset.chapter_id || '';
                    document.getElementById("e_code").value = this.dataset.code || '';
                    document.getElementById("e_departmentInput").value = this.dataset.name || '';
                    document.getElementById("e_headOfInput").value = this.dataset.description || '';
                    document.getElementById("e_head_user_id").value = this.dataset.head_user_id ||
                        '';
                    document.getElementById("e_status").value = this.dataset.status || 'active';

                    // Set form action URL
                    const form = document.getElementById("edit-form");
                    form.action = "/subchapter_department/list/" + this.dataset.id;
                });
            });
        });
    </script>
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('subchapter_department.destroy', ':id') }}";
