                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex gap-2 shrink-0">
                            ...
                            <a href="{{ route('contract-cases.create-contract-case') }}"
                                ...
                                <span class="align-middle">Add Contract Cases</span>
                            </a>
                        </div>
                    </div>
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('contract-cases.edit-contract-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('contract-cases.destroy-contract-case', ':id') }}";
