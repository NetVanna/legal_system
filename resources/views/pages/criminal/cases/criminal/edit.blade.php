    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Correction Of Criminal Cases</h5>
                </div>
            ...
            <form action="{{ route('criminal-cases.update-criminal-case', $cases->id) }}" method="POST"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <div>
                                <label for="court" class="inline-block mb-2 text-base font-medium">Court</label>
                                ...
                                <select
                                    ...
                                    @php
                                        $courts = [
                                            ...
                                            'Kampong Cham Provincial Court',
                                            'Kampong Chhnang Provincial Court',
                                            'Kampong Speu Provincial Court',
                                            'Kampong Thom Provincial Court',
                                            'Kampot Provincial Court',
                                            'Koh Kong Provincial Court',
                                            'Kep Provincial Court',
                                            'Kratie Provincial Court',
                                            'Mondulkiri Provincial Court',
                                            'Preah Vihear Provincial Court',
                                            'Prey Veng Provincial Court',
                                            'Battambang Provincial Court',
                                            'Banteay Meanchey Provincial Court',
                                            'Pursat Provincial Court',
                                            'Rattanakiri Provincial Court',
                                            'Siem Reap Provincial Court',
                                            'Stung Treng Provincial Court',
                                            'Svay Rieng Provincial Court',
                                            'Takeo Provincial Court',
                                            'Tbong Khmum Provincial Court',
                                            'Oddar Meanchey Provincial Court',
                                            'Preah Sihanouk Provincial Court',
                                            'Phnom Penh Court Of Appeal',
                                            'Tbong Khmum Appeal Court',
                                            'Battambang Court Of Appeal',
                                            'Preah Sihanouk Court Of Appeal',
                                            'Supreme Court',
                                        ];

                                        // get selected value: priority old() → database value
                                        $selectedCourt = old('case_data.0.court', $cases->case_data[0]['court'] ?? '');
                                    @endphp
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="discount" name="discount"
                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                    placeholder="E.G.. 10% Or 100$" value="{{ old('discount', $cases->discount ?? '') }}">
                            </div>
