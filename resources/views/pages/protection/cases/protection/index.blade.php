                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex gap-2 shrink-0">
                            ...
                            <a href="{{ route('protection-cases.create-protection-case') }}"
                                ...
                                <span class="align-middle">Add Protection Cases</span>
                            </a>
                        </div>
                    </div>
                    <br>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-b border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            ...
                                            <a href="{{ route('protection-cases.edit-protection-case', $value->id) }}"
...
@section('script')
    ...
    <script>
        $(document).on('click', '#deleteRecord', function() {
            ...
            var url = "{{ route('protection-cases.destroy-protection-case', ':id') }}";
