...
@section('sidebar')
    <div id="scrollbar"
        ...
        @include('pages.protection.sidebar.sidebar')
        <!-- Left Sidebar End -->
    </div>
@endsection
{{-- content --}}
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Create A Defense Case</h5>
                </div>
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('protection-cases.protection') }}" class="text-slate-400 dark:text-zink-200">Case</a>
                    </li>
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1 before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('protection-cases.create-protection-case') }}"
                            class="text-slate-400 dark:text-zink-200">Create New</a>
                    </li>
                    <li class="text-slate-700 dark:text-zink-100">Defendant Case</li>
                </ul>
            </div>

            <form action="{{ route('protection-cases.store-protection-case') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="case_type" value="Defendant Case">
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                            ...
                            <div>
                                <label for="closed_date"
                                    class="inline-block mb-2 text-base font-medium">Court</label>
                                <select
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            data-choices="" name="case_data[0][court]" id="court">
                            <option value="">-- Choose A Court Name --</option>
                            <option value="Phnom Penh Municipal Court"
                                        {{ old('court') == 'Phnom Penh Municipal Court' ? 'selected' : '' }}>
                                        Phnom Penh Municipal Court</option>
                                    <option value="Kandal Provincial Court"
                                        {{ old('court') == 'Kandal Provincial Court' ? 'selected' : '' }}>
                                        Kandal Provincial Court</option>
                                    <option value="Kampong Cham Provincial Court"
                                        {{ old('court') == 'Kampong Cham Provincial Court' ? 'selected' : '' }}>
                                        Kampong Cham Provincial Court</option>
                                    <option value="Kampong Chhnang Provincial Court"
                                        {{ old('court') == 'Kampong Chhnang Provincial Court' ? 'selected' : '' }}>
                                        Kampong Chhnang Provincial Court</option>
                                    <option value="Kampong Speu Provincial Court"
                                        {{ old('court') == 'Kampong Speu Provincial Court' ? 'selected' : '' }}>
                                        Kampong Speu Provincial Court</option>
                                    <option value="Kampong Thom Provincial Court"
                                        {{ old('court') == 'Kampong Thom Provincial Court' ? 'selected' : '' }}>
                                        Kampong Thom Provincial Court</option>
                                    <option value="Kampot Provincial Court"
                                        {{ old('court') == 'Kampot Provincial Court' ? 'selected' : '' }}>
                                        Kampot Provincial Court</option>
                                    <option value="Koh Kong Provincial Court"
                                        {{ old('court') == 'Koh Kong Provincial Court' ? 'selected' : '' }}>
                                        Koh Kong Provincial Court</option>
                                    <option value="Kep Provincial Court"
                                        {{ old('court') == 'Kep Provincial Court' ? 'selected' : '' }}>
                                        Kep Provincial Court</option>
                                    <option value="Kratie Provincial Court"
                                        {{ old('court') == 'Kratie Provincial Court' ? 'selected' : '' }}>
                                        Kratie Provincial Court</option>
                                    <option value="Mondulkiri Provincial Court"
                                        {{ old('court') == 'Mondulkiri Provincial Court' ? 'selected' : '' }}>
                                        Mondulkiri Provincial Court</option>
                                    <option value="Preah Vihear Provincial Court"
                                        {{ old('court') == 'Preah Vihear Provincial Court' ? 'selected' : '' }}>
                                        Preah Vihear Provincial Court</option>
                                    <option value="Prey Veng Provincial Court"
                                        {{ old('court') == 'Prey Veng Provincial Court' ? 'selected' : '' }}>
                                        Prey Veng Provincial Court</option>
                                    <option value="Battambang Provincial Court"
                                        {{ old('court') == 'Battambang Provincial Court' ? 'selected' : '' }}>
                                        Battambang Provincial Court</option>
                                    <option value="Banteay Meanchey Provincial Court"
                                        {{ old('court') == 'Banteay Meanchey Provincial Court' ? 'selected' : '' }}>
                                        Banteay Meanchey Provincial Court</option>
                                    <option value="Pursat Provincial Court"
                                        {{ old('court') == 'Pursat Provincial Court' ? 'selected' : '' }}>
                                        Pursat Provincial Court</option>
                                    <option value="Rattanakiri Provincial Court"
                                        {{ old('court') == 'Rattanakiri Provincial Court' ? 'selected' : '' }}>
                                        Rattanakiri Provincial Court</option>
                                    <option value="Siem Reap Provincial Court"
                                        {{ old('court') == 'Siem Reap Provincial Court' ? 'selected' : '' }}>
                                        Siem Reap Provincial Court</option>
                                    <option value="Stung Treng Provincial Court"
                                        {{ old('court') == 'Stung Treng Provincial Court' ? 'selected' : '' }}>
                                        Stung Treng Provincial Court</option>
                                    <option value="Svay Rieng Provincial Court"
                                        {{ old('court') == 'Svay Rieng Provincial Court' ? 'selected' : '' }}>
                                        Svay Rieng Provincial Court</option>
                                    <option value="Takeo Provincial Court"
                                        {{ old('court') == 'Takeo Provincial Court' ? 'selected' : '' }}>
                                        Takeo Provincial Court</option>
                                    <option value="Tbong Khmum Provincial Court"
                                        {{ old('court') == 'Tbong Khmum Provincial Court' ? 'selected' : '' }}>
                                        Tbong Khmum Provincial Court</option>
                                    <option value="Oddar Meanchey Provincial Court"
                                        {{ old('court') == 'Oddar Meanchey Provincial Court' ? 'selected' : '' }}>
                                        Oddar Meanchey Provincial Court</option>
                                    <option value="Preah Sihanouk Provincial Court"
                                        {{ old('court') == 'Preah Sihanouk Provincial Court' ? 'selected' : '' }}>
                                        Preah Sihanouk Provincial Court</option>
                                    <option value="Phnom Penh Court Of Appeal"
                                        {{ old('court') == 'Phnom Penh Court Of Appeal' ? 'selected' : '' }}>
                                        Phnom Penh Court Of Appeal</option>
                                    <option value="Tbong Khmum Appeal Court"
                                        {{ old('court') == 'Tbong Khmum Appeal Court' ? 'selected' : '' }}>
                                        Tbong Khmum Appeal Court</option>
                                    <option value="Battambang Court Of Appeal"
                                        {{ old('court') == 'Battambang Court Of Appeal' ? 'selected' : '' }}>
                                        Battambang Court Of Appeal</option>
                                    <option value="Preah Sihanouk Court Of Appeal"
                                        {{ old('court') == 'Preah Sihanouk Court Of Appeal' ? 'selected' : '' }}>
                                        Preah Sihanouk Court Of Appeal</option>
                                    <option value="Supreme Court"
                                        {{ old('court') == 'Supreme Court' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <select id="payment_status" name="payment_status"
                                    ...
                                    <option value="partial" {{ old('payment_status') == 'partial' ? 'selected' : '' }}>
                                        Part Payment</option>
                                    <option value="paid" {{ old('payment_status') == 'paid' ? 'selected' : '' }}>Already Paid
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <a href="{{ route('protection-cases.protection') }}"
