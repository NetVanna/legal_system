...
<head>
    <meta charset="utf-8">
    <title>NRS-Company-System</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
    <meta content="Minimal Admin & Dashboard Template" name="description">
    <meta content="NRS-Company" name="author">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- App favicon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/logo/istockphoto-1166663604-612x612.jpg') }}">
    {{-- <link rel="icon" type="image/png" href="{{ asset('assets/images//logo/logo.jpg') }}"> --}}
    <!-- Layout config Js -->
        ...
        <div
            ...
            <div
                ...
                <a href="{{ route('admin.home') }}"
                    class="block group-data-[sidebar=dark]:hidden group-data-[sidebar=brand]:hidden group-data-[sidebar=modern]:hidden">
                    <span class="hidden group-data-[sidebar-size=sm]:block">
                        <img src="{{ URL::to('assets/images/logo/istockphoto-1166663604-612x612.jpg') }}" alt="Logo" class="h-6 mx-auto object-contain">
                    </span>
                    <span class="group-data-[sidebar-size=sm]:hidden">
                        <img src="{{ URL::to('assets/images/logo/istockphoto-1166663604-612x612.jpg') }}" alt="Logo" class="h-12 w-auto mx-auto object-contain">
                    </span>
                </a>
                <a href="{{ route('admin.home') }}"
                        ...
                        <div
                            ...
                            <a href="{{ route('admin.home') }}">
                                ...
                                <span class="group-data-[topbar=dark]:hidden group-data-[topbar=brand]:hidden">
                                    <img src="{{ asset('assets/images/logo/istockphoto-1166663604-612x612.jpg') }}" alt=""
                                        class="h-6 mx-auto">
                                </span>
                            </a>
                            <a href="{{ route('admin.home') }}"
                                ...
                                <button type="button"
                                    ...
                                    <div class="bg-pink-100 rounded-full">
                                        @php
                                            ...
                                            $photo = $user->photo ?? null; // assuming 'photo' is the column
                                        @endphp

                                        @if ($photo)
                                            <img src="{{ URL::to('assets/images/user/' . $photo) }}"
                                                alt="{{ $fullName }}" class="h-10 rounded-full">
                                        @elseif (!empty($initials))
                                            <div
                                                class="flex items-center justify-center font-medium rounded-full h-10 w-10 shrink-0 bg-slate-200 text-slate-800 dark:text-zinc-50 dark:bg-zinc-600">
                                                {{ $initials }}
                                            </div>
                                        @else
                                            <img src="{{ asset('assets/images/avatar-7.png') }}"
                                                alt="Default profile" class="h-10 rounded-full">
                                        @endif
                                    </div>
                                        ...
                                        <div class="relative inline-block shrink-0">
                                            <div class="rounded bg-slate-100 dark:bg-zink-500">
                                                @php
                                                    ...
                                                    $photo = $user->photo ?? null; // adjust if your photo field is named differently
                                                @endphp

                                                @if (!empty($photo))
                                                    <img src="{{ asset('assets/images/user/' . $photo) }}"
                                                        alt="{{ $fullName }}" class="h-10 rounded-full">
                                                @else
                                                    <div
                    ...
                    <div
                        ...
                        <div class="hidden lg:block">
                            <div class="ltr:text-right rtl:text-left">
                                Design & Develop by Free-IT TeamWork
                            </div>
                        </div>
                    </div>
                </div>
