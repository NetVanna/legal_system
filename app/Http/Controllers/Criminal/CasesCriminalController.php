...
class CasesCriminalController extends Controller
{
    public function index(){
         $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'រឿងក្ដីព្រហ្មទណ្ឌ')
            ->orderBy('created_at', 'desc')
            ->get();
        return view("pages.criminal.cases.criminal.index",compact("cases"));
    }
    public function create()
    {
        ...
        return view("pages.criminal.cases.criminal.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/criminal');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/criminal/' . $fileName,
            ...
            return redirect()->route('criminal-cases.criminal')
    ...
    public function edit($id)
    {
        ...
        return view('pages.criminal.cases.criminal.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
