...
class CasesProtectionController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'រឿងក្ដីរក្សាការពារ')
            ->orderBy('created_at', 'desc')
            ->get();
        return view("pages.protection.cases.protection.index", compact("cases"));
    }
    public function create()
    {
        ...
        return view("pages.protection.cases.protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/protection');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/protection/' . $fileName,
            ...
            return redirect()->route('protection-cases.protection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.protection.cases.protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
