...
class CasesOutcourtController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'ដោះស្រាយក្រៅតុលាការ')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.outcourt.cases.outcourt.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.outcourt.cases.outcourt.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/outcourt');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/outcourt/' . $fileName,
            ...
            return redirect()->route('outcourt-cases.outcourt')
    ...
    public function edit($id)
    {
        ...
        return view('pages.outcourt.cases.outcourt.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
