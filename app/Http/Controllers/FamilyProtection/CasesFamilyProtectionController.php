...
class CasesFamilyProtectionController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'គាំពារគ្រួសារ')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.family_protection.cases.family_protection.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.family_protection.cases.family_protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/family-protection');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/family-protection/' . $fileName,
            ...
            return redirect()->route('familyprotection-cases.familyprotection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.family_protection.cases.family_protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
