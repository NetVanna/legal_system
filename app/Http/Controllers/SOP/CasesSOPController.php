...
class CasesSOPController extends Controller
{
    public function index()
    {
        ...
        return view("pages.sop.cases.sop.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.sop.cases.sop.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('sop-cases.sop')
    ...
    public function edit($id)
    {
        ...
        return view('pages.sop.cases.sop.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
