...
class CasesIndividualProtectionController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'គាំពារបុគ្គល')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.individual_protection.cases.personal_protection.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.individual_protection.cases.personal_protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/personal-protection');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/personal-protection/' . $fileName,
            ...
            return redirect()->route('individualprotection-cases.individualprotection')
    ...
    public function edit($id)
    {
        ...
        // Load the same data as create form
        $clients = Clients::all();
        $lawyers = User::all();
        $instructors = User::all();
        $chapters = ChapterDepartments::all();
        ...
        return view('pages.individual_protection.cases.personal_protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
