...
class OtherCasesController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'ផ្សេងៗ')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.admin.cases.others.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.others.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/other-cases');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/other-cases/' . $fileName,
            ...
            return redirect()->route('cases.othercase')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.others.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
