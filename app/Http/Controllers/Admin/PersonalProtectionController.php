...
class PersonalProtectionController extends Controller
{
    public function index()
    {
        ...
        return view("pages.admin.cases.personal_protection.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.personal_protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.personalprotection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.personal_protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
