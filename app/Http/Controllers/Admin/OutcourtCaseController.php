...
class OutcourtCaseController extends Controller
{
    public function index()
    {
        ...
        return view("pages.admin.cases.outcourts.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.outcourts.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.outcourt')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.outcourts.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
