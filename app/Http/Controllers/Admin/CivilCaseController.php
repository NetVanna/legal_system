...
class CivilCaseController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ...
            ->get();
        return view("pages.admin.cases.civils.index", compact("cases"));
    }
    public function create()
    {
        ...
        return view("pages.admin.cases.civils.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.civil')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.civils.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
