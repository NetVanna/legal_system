...
class FamilyProtectionCaseController extends Controller
{
    public function index()
    {
        ...
        return view("pages.admin.cases.family_protection.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.family_protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.familyprotection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.family_protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
