...
class ProtectionCaseController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ...
            ->get();
        return view("pages.admin.cases.protection.index", compact("cases"));
    }
    public function create()
    {
        ...
        return view("pages.admin.cases.protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.protection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
