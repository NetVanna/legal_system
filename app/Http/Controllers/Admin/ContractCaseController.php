...
class ContractCaseController extends Controller
{
    public function index()
    {
        ...
        return view("pages.admin.cases.contract.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.contract.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.contract')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.contract.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
