...
class SOPCaseController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'ស្ដង់ដារអាជីវកម្ម')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.admin.cases.sop.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.admin.cases.sop.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/sop');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/sop/' . $fileName,
            ...
            return redirect()->route('cases.sop')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.sop.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
