...
class CriminalCaseController extends Controller
{
    public function index()
    {
        ...
        return view("pages.admin.cases.criminals.index", compact('cases'));
    }
    public function create()
    {
        ...
        return view("pages.admin.cases.criminals.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('cases.criminal')
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.cases.criminals.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
