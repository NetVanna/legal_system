...
class CasesBusinessProtectionController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'គាំពារអាជីវកម្ម')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.business_protection.cases.business_protection.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.business_protection.cases.business_protection.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/business-protection');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/business-protection/' . $fileName,
            ...
            return redirect()->route('businessprotection-cases.businessprotection')
    ...
    public function edit($id)
    {
        ...
        return view('pages.business_protection.cases.business_protection.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
