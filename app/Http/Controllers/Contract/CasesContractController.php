...
class CasesContractController extends Controller
{
    public function index()
    {
        $cases = Cases::with(['client', 'lawyer', 'instructor'])
            ->where('case_type', 'កិច្ចសន្យា')
            ->orderBy('created_at', 'desc')
            ->get();

        return view("pages.contract.cases.contract.index", compact('cases'));
    }
    ...
    public function create()
    {
        ...
        return view("pages.contract.cases.contract.create", compact(
            'clients',
            'lawyers',
            'instructors',
            'chapters',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('documents')) {
                ...
                $documentPath = public_path('assets/documents/cases/contract');
                ...
                foreach ($request->file('documents') as $file) {
                    try {
                        ...
                        $documentsData[] = [
                            ...
                            'file_path' => 'assets/documents/cases/contract/' . $fileName,
            ...
            return redirect()->route('contract-cases.contract')
    ...
    public function edit($id)
    {
        ...
        return view('pages.contract.cases.contract.edit', compact(
            'cases',
            'clients',
            'lawyers',
            'instructors',
